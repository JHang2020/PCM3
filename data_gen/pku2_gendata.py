...
def gendata(data_path, out_path, benchmark='xview', part='eval'):
    ...
    with open('/mnt/netdisk/zhangjh/Code/CMD-main/data_gen/pku_cross_subject_v2.txt', 'r') as f:
        lines = f.readlines()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/mnt/netdisk/Datasets/088-PKUMMD/PKUMMDv2/')
    parser.add_argument('--out_folder', default='/mnt/netdisk/zhangjh/data/CMD/PKUMMD2/')
